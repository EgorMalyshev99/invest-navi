...
export type RefreshTokensMutation = { refreshTokens: { accessToken: string, refreshToken: string } };
...
export type MeQuery = { me: { userId: string, email: string, name: string | null, knowledgeLevel: KnowledgeLevel, preferredLocale: PreferredLocale } };
