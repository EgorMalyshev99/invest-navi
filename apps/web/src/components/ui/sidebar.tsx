...
function useSidebar() {
  // eslint-disable-next-line @eslint-react/no-use-context -- shadcn pattern
...
function SidebarProvider({
  ...
  // eslint-disable-next-line @eslint-react/use-state -- shadcn internal naming convention
  ...
  return (
    // eslint-disable-next-line @eslint-react/no-context-provider -- shadcn pattern
