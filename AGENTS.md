...
> Полное описание бизнес-логики, разделов платформы и сценариев — в [PRODUCT.md](./PRODUCT.md).
...
Полная концепция — в [DESIGN.md](./DESIGN.md).
...
- [PRODUCT.md](./PRODUCT.md) — полное описание бизнес-логики, разделов, сценариев
- [DESIGN.md](./DESIGN.md) — дизайн-концепция, палитра, компоненты, адаптивность
- [README.md](./README.md)
